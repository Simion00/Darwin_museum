...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Darwin Museum Collections</title>
	...
	<body>
		...
		<nav id="nav" class="skel-panels-fixed">
			<ul>
				<li class='current_page_item'><a href='collections'>collections</a></li>
				<?php echo $links; ?>
			</ul>
		</nav>
					...
					<div class="9u skel-cell-mainContent">
						<div class="content content-right">
							...
							<article class="is-page-content">
								...
								<section>
									<span><img src="../assets/images/map.png" alt="map" /></span>
								</section>
								
								<div id="floors">
									<div id="floor">
										<h3>&larr;Floor 3</h3>
										<a href="floor3">Stuff</a>
									</div>
									<div id="floor">
										<h3>&larr;Floor 2</h3>
										<a href="floor2">Stuff</a>
									</div>
									<div id="floor">
										<h3>&larr;Floor 1</h3>
										<a href="floor1">Stuff</a>
									</div>
								</div>
							</article>
