...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Darwin Museum Trip</title>
	...
	<body>
		...
		<nav id="nav" class="skel-panels-fixed">
			<ul>
				<li class='current_page_item'><a href='trip'>trip</a></li>
				<?php echo $links; ?>
			</ul>
		</nav>
					...
					<div class="9u skel-cell-mainContent">
						<div class="content content-right">
							...
							<article class="is-page-content">
								...
								<section>
									<iframe src="https://www.google.com/maps/d/embed?mid=ztVAUCFIBEdI.kWpcDFETAl9A" width="640" height="480"></iframe>
									<br />
									<h2>
										Schip. 
									</h2>
