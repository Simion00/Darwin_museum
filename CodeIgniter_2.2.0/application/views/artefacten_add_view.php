...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Darwin Museum artefacten add</title>
					...
					<div class="9u skel-cell-mainContent">
						<div class="content content-right">
							...
							<article class="is-page-content">
								<header>
									<h2>Artefacten add</h2>
									<span class="byline">Welcome!</span>
								</header>
								
								<section>
									<?php echo validation_errors(); ?>
									<?php echo form_open_multipart('verify_artefacten_add'); ?>
										<label for="naam">Naam:</label>
										<input type="text" size="20" id="naam" name="naam"/>
										<br/>
										<label for="omschrijving">Omschrijving:</label>
										<br/>
										<textarea rows="5" cols="50" id="omschrijving" name="omschrijving"/></textarea>
										<br/>
										<label for="geologische_perioden">Geologische Perioden:</label>
										<input type="textarea" size="20" id="geologische_perioden" name="geologische_perioden"/>
										<br/>
										<label for="aanschafdatum">Aanschafdatum:</label>
										<input type="text" size="20" id="aanschafdatum" name="aanschafdatum"/>
										<br/>
										<label for="afbeelding">Afbeelding:</label>
										<input type="file" id="afbeelding" name="afbeelding"/>
										<br/>
										<label for="zaal">Zaal:</label>
										<input type="text" size="20" id="zaal" name="zaal"/>
										<br/>
										<label for="locatie">Locatie:</label>
										<input type="text" size="20" id="locatie" name="locatie"/>
										<br/>
